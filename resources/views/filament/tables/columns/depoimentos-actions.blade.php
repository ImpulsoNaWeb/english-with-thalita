<div class="flex items-center gap-x-3 justify-end px-3">
    <a href="{{ \App\Filament\Resources\DepoimentoResource::getUrl('edit', ['record' => $getRecord()]) }}" class="fi-link fi-color-primary flex items-center gap-1 text-sm font-medium hover:underline">
